...
export const ChevronRightIcon = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="bg-blue-500 text-white rounded-full p-[2px] lucide lucide-chevron-right-icon lucide-chevron-right"
    >
...
export const SquareArrowUpRightIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const PlusIcon = ({ className = "", stroke = "currentColor" }: { className?: string; stroke?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
